    ...
    jQuery(document).ready(function($) {
		...
		$.ajax({
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><label for="scheme">Comments Order</label></th>
					<td>
						<select name="fbcommentssync[order]">
							<option value="reverse_time"<?php if ($options['order'] == 'reverse_time') { echo ' selected="selected"'; } ?>>Newest Comments First</option>
							<option value="time"<?php if ($options['order'] == 'time') { echo ' selected="selected"'; } ?>>Oldest Comments First</option>
							<option value="social"<?php if ($options['order'] == 'social') { echo ' selected="selected"'; } ?>>Highest Quality First</option>
						</select>
					</td>
				</tr>
